...
The <a href="http://www.youtube.com/watch?feature=player_embedded&v=zhEGFfCJwTg" target="_blank">CoAP Shell video<img src="http://img.youtube.com/vi/zhEGFfCJwTg/0.jpg" alt="CoAP Shell video" width="240" height="180" border="10" /></a> highlights some of the basic features provided.
