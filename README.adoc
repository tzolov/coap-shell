...
* `SpringBoot`, self-executable jar, running on any Java 8+ environment.
...
NOTE: If you see `org.eclipse.californium.elements.EndpointMismatchException` error message that means that your DTLS session has expired
...
NOTE: If you see `org.eclipse.californium.elements.EndpointMismatchException` message that means that your DTLS session has expired
