...
* Get a pre-build https://bintray.com/big-data/maven/download_file?file_path=io%2Fdatalake%2Fcoap%2Fcoap-shell%2F1.0.7%2Fcoap-shell-1.0.7.jar[coap-shell.jar] or build one yourself following the instructions further down.
...
[source,bash]
----
java -jar ./target/coap-shell-1.0.8-SNAPSHOT.jar --logging.level.org.eclipse.californium=DEBUG
----
